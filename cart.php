...
<main>
  ...
  <div class="nero">
    <div class="nero__heading">
      <span class="nero__bold">TOKO</span> Keranjang
    </div>
    <p class="nero__text">
    </p>
  </div>
</main>
<div id="content"><!-- Konten Starts -->
  <div class="container"><!-- Kontainer Starts -->
    <div class="col-md-9" id="cart"><!-- col-md-9 Starts -->
      <div class="box"><!-- Kotak Starts -->
        <form action="cart.php" method="post" enctype="multipart/form-data"><!-- form Starts -->
          ...
          ?>
          <p class="text-muted"> Anda saat ini memiliki <?php echo $count; ?> item di keranjang anda. </p>
          <div class="table-responsive"><!-- table-responsive Starts -->
            ...
            <div class="form-inline pull-right"><!-- form-inline pull-right Starts -->
              ...
              <input class="btn btn-primary" type="submit" name="apply_coupon" value="Gunakan Kode Kupon">
          ...
          <div class="box-footer"><!-- box-footer Starts -->
            ...
            <div class="pull-right"><!-- pull-right Starts -->
              <button class="btn btn-info" type="submit" name="update" value="Update Keranjang">
                <i class="fa fa-refresh"></i> Perbarui Keranjang

              </button>
              <a href="checkout.php" class="btn btn-success">
                Lanjutkan ke Pembayaran <i class="fa fa-chevron-right"></i>
      ...
      <div id="row same-height-row"><!-- row same-height-row Starts -->
        <div class="col-md-3 col-sm-6"><!-- col-md-3 col-sm-6 Starts -->
          <div class="box same-height headline"><!-- box same-height headline Starts -->
            <h3 class="text-center"> Anda Mungkin Menyukai Produk Ini </h3>
...
";
    ...
    <div class="col-md-3"><!-- col-md-3 Starts -->
      <div class="box" id="order-summary"><!-- box Starts -->
        ...
        <p class="text-muted">
          Biaya pengiriman dan tambahan dihitung berdasarkan nilai yang telah Anda masukkan.
        </p>
        <div class="table-responsive"><!-- table-responsive Starts -->
          <table class="table"><!-- table Starts -->
            <tbody><!-- tbody Starts -->
